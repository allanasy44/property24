...
class PropertyCreateForm(JsonForm):
    ...
    show_exact_location = forms.BooleanField(required=False)
    listing_intent = forms.ChoiceField(choices=Property.ListingIntent.choices, required=False)
    intent = forms.ChoiceField(choices=Property.ListingIntent.choices, required=False)
    availability_status = forms.ChoiceField(choices=Property.AvailabilityStatus.choices, required=False)
